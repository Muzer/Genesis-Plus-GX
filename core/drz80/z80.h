...
extern void z80_init(const void *config, int (*irqcallback)(int)); // used
extern void z80_reset (void); // used
extern void z80_run(unsigned int cycles); // used
extern void z80_get_context (void *dst);
extern void z80_set_context (void *src);
extern void z80_set_irq_line(unsigned int state); // used
extern void z80_set_nmi_line(unsigned int state); // used
